...
//1 Build the internal net
function generateInternalGraph() {
    const IN = {A:[], B:[], C:[], D:[]};  // Internal Nodes
    const IE = {A:[], B:[], C:[], D:[]};  // Internal Edges
    const BS = {A:{}, B:{}, C:{}, D:{}};  // Building Stops
...
//2 Build the internal paths for each block
...
//4 Paint arrows at the apartment delivery stops
...
// Build graph for internal paths within each block.
